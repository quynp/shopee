 ...
 * @property Nodes\Categories\Categories categories
 */
class Client
{
    ...
    public const DEFAULT_USER_AGENT = 'shopee/' . self::VERSION;
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->nodes['categories'] = new Nodes\Categories\Categories($this);
    }
